...
public abstract class StringUtils {
	...
	public static String cleanPath(String path) {
		...
		// "file:core/../core/io/Controller.class", where the ".." should just
     ...
     * <p>This is the inverse arithmeticexpression of {@link Locale#toString Locale's toString}.
	 ...
	 * prior to attempting the split arithmeticexpression (typically the quotation mark
